// Lightweight anti-spam for the public, unauthenticated newsletter signup
// form. In-memory, per-IP, never persisted: the IP is read only to make an
// allow/reject decision for a few minutes, never logged, never written to
// the database, gone on every restart.
